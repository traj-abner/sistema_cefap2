 ...
 */
$config['replacer'] = array('main' => 'Geral', 'add' => 'Adicionar', 'usuarios' => "Usuários", "ID" => "","Id" => "", "Nome" => "", "Status" => "", "ASC" => "","CRESC" => "", "DESC" => "", "Data Vencimento" =>"","Data Emiss�o" => "","Valor" => "", "Nosso Numero" => "","Success"=>"");
